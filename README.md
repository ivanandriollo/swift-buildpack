...
```shell
wget https://github.com/IBM-Swift/swift-buildpack/releases/download/2.0.19/buildpack_swift_v2.0.19-20190303-1915.zip
ibmcloud cf create-buildpack swift_buildpack buildpack_swift_v2.0.19-20190303-1915.zip <position>
```
...
```shell
wget https://github.com/IBM-Swift/swift-buildpack/releases/download/2.0.19/buildpack_swift_v2.0.19-20190303-1915.zip
ibmcloud cf update-buildpack swift_buildpack -p buildpack_swift_v2.0.19-20190303-1915.zip
```
